...
proj :: Node -> Node -> Edge
proj n1 n2 = DenseProjection defaultProjection n1 n2

defaultProjection = Static Excitatory (AllToAll (BiasGenerator (Constant 0)) (WeightGenerator (GaussianRandom 1.0 1.0)))
...
spec = do
  ...
  describe "The SNN program generator" $ do
    it "can generate a simple SNN program" $ do
      ...
      let network = Network 4 [n1] [] [DenseProjection defaultProjection n1 n2] [n2]
    ...
    it "can generate parallel networks" $ do
      ...
      let p1 = DenseProjection defaultProjection n1 n2
      let p2 = DenseProjection defaultProjection n3 n4
    ...
    it "can connect sequential and parallel networks" $ do
      ...
      let p2 = proj n3 n4
      let p3 = proj n5 n6
      let p4 = ReplicateProjection defaultProjection n2 (n3, n5)
    ...
    it "can connect parallel and sequential networks" $ do
      ...
      let p2 = proj n3 n4
      let p3 = proj n5 n6
      let p4 = MergeProjection defaultProjection (n2, n4) n5
